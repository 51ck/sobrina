...
- [ ] **T1.1** Root `package.json`: private workspaces `packages/*`, `"type": "module"`, placeholder root scripts
- [ ] **T1.2** `packages/core`: `@sobrina/core` package.json + minimal `src/index.ts` export stub
